...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Activity } from 'lucide-react';

export default function HybridRestaurantOrdersPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Orders In Progress" 
        eyebrow="Restaurant > Live Orders"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Live Orders" value="14" delta="" />
        <StatCard label="Avg Fulfillment" value="18m" delta="" />
      </div>
