...
export default function RestaurantWaitingPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Waiting List" 
        eyebrow="Tables > Waitlist"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Parties Waiting" value="5" delta="" />
        <StatCard label="Est. Wait Time" value="25m" delta="" />
      </div>
