...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, FileText } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard label="Generated Today" value="28" delta="" />
        <StatCard label="Pending Payment" value="5" delta="$1,240" />
      </div>
