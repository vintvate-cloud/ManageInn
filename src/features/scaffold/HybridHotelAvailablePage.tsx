...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, CheckSquare } from 'lucide-react';

export default function HybridHotelAvailablePage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Available Rooms" 
        eyebrow="Hotel > Availability"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Available Tonight" value="32" delta="" />
        <StatCard label="Ready to Assign" value="28" delta="" />
      </div>
