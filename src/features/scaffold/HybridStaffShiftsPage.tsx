...
export default function HybridStaffShiftsPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Upcoming Shifts" value="45" delta="Next 3 Days" />
        <StatCard label="Open Shifts" value="4" delta="Coverage Needed" />
      </div>
