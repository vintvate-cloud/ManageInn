...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Shirt } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard label="Loads Today" value="18" delta="" />
        <StatCard label="Guest Requests" value="4" delta="2 Pending" />
      </div>
