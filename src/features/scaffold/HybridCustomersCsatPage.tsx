...
export default function HybridCustomersCsatPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Customer Satisfaction Score" 
        eyebrow="Customers > Feedback"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Hotel CSAT" value="4.6/5" delta="" />
        <StatCard label="Restaurant CSAT" value="4.8/5" delta="" />
      </div>
