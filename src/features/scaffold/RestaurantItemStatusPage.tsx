...
export default function RestaurantItemStatusPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Item Availability" 
        eyebrow="Menu > 86 List"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Items 86'd" value="3" delta="Out of stock" />
        <StatCard label="Low Warning" value="5" delta="" />
      </div>
