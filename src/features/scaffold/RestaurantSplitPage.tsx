...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, SplitSquareHorizontal } from 'lucide-react';

export default function RestaurantSplitPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Split Payments" 
        eyebrow="Billing > Splitting"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Split Orders" value="12" delta="Today" />
        <StatCard label="Avg Split Size" value="2.5" delta="Cards per order" />
      </div>
