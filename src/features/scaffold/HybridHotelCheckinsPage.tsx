...
export default function HybridHotelCheckinsPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Today's Check-Ins" 
        eyebrow="Hotel > Arrivals"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Expected Arrivals" value="18" delta="" />
        <StatCard label="Checked In" value="12" delta="6 remaining" />
      </div>
