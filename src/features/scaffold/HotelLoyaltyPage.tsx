...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Heart } from 'lucide-react';

export default function HotelLoyaltyPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard label="Active Members" value="4,800" delta="33% of base" />
        <StatCard label="Points Redeemed" value="450K" delta="YTD" />
      </div>
      ...
      ['Silver', '3,150', 'Welcome Drink', '$1,100', <ActionButtons />],
        ...
        <div className="p-4 border-t border-border flex justify-between items-center text-sm text-muted-foreground bg-muted/10">
          <div>Showing 1 to 3 of 48 results</div>
