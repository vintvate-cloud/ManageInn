...
export default function HybridCustomersLoyaltyPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Total Members" value="4,200" delta="" />
        <StatCard label="Points Liability" value="1.2M" delta="Unredeemed" />
      </div>
