...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, ArrowUpCircle } from 'lucide-react';

export default function HotelUpgradesPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard label="Upgrades Today" value="5" delta="" />
        <StatCard label="Upsell Revenue" value="$850" delta="+12%" />
      </div>
