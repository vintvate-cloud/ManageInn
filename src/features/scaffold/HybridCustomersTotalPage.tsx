...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Users } from 'lucide-react';

export default function HybridCustomersTotalPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Total Guests" 
        eyebrow="Customers > Overview"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Unique Guests" value="18,450" delta="Lifetime" />
        <StatCard label="Cross-over" value="14%" delta="Stayed & Dined" />
      </div>
