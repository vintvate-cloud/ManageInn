...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Clock } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard label="Dirty Rooms" value="24" delta="Requires Cleaning" />
        <StatCard label="In Progress" value="8" delta="" />
        <StatCard label="Cleaned Today" value="45" delta="" />
      </div>
