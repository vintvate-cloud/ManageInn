...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Truck } from 'lucide-react';

export default function RestaurantVendorsPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Active Vendors" value="12" delta="" />
        <StatCard label="Outstanding Payables" value="$2,450" delta="" />
      </div>
