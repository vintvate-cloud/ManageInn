...
export default function HybridHotelOccupiedPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Occupied Rooms" 
        eyebrow="Hotel > Occupancy"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Occupancy Rate" value="84%" delta="" />
        <StatCard label="Total Guests In-House" value="210" delta="" />
      </div>
