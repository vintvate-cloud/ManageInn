...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Trash2 } from 'lucide-react';

export default function RestaurantWastePage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Waste Cost (MTD)" value="$345" delta="-12%" />
        <StatCard label="Most Wasted" value="Lettuce" delta="" />
      </div>
