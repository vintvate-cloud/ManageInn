...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, HandCoins } from 'lucide-react';

export default function HybridFinanceIncomePage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Income" 
        eyebrow="Finance > Inflow"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Total Income (MTD)" value="$145,000" delta="" />
        <StatCard label="Receivables" value="$8,400" delta="Pending Invoices" />
      </div>
