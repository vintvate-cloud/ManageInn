...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, ArrowRightLeft } from 'lucide-react';

export default function HybridHotelCheckoutsPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Today's Check-Outs" 
        eyebrow="Hotel > Departures"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Expected Departures" value="24" delta="" />
        <StatCard label="Checked Out" value="20" delta="4 remaining" />
      </div>
