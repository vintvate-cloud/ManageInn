...
export default function HotelStaffShiftsPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard label="Open Shifts" value="3" delta="Next 7 Days" />
        <StatCard label="Overtime Alerts" value="1" delta="Review Required" />
      </div>
