...
export default function RestaurantReportsFoodCostPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Food Cost Report" 
        eyebrow="Analytics > Costs"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Overall Food Cost" value="32%" delta="Target: 30%" />
        <StatCard label="Waste Impact" value="2.5%" delta="of total cost" />
      </div>
