...
export default function RestaurantPaymentModesPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Payment Modes" 
        eyebrow="Billing > Gateways"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Card / Digital" value="78%" delta="Usage" />
        <StatCard label="Cash" value="22%" delta="Usage" />
      </div>
