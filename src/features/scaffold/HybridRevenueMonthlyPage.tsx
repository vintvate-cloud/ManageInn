...
export default function HybridRevenueMonthlyPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Monthly Revenue" 
        eyebrow="Revenue > Monthly"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="MTD Total" value="$145,000" delta="+8% vs last month" />
        <StatCard label="Projected" value="$210,000" delta="" />
      </div>
