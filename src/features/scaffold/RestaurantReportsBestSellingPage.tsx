...
export default function RestaurantReportsBestSellingPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Top Category" value="Mains" delta="45% of sales" />
        <StatCard label="Top Item" value="Cheeseburger" delta="142 sold" />
      </div>
