...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Percent } from 'lucide-react';

export default function RestaurantReportsMarginPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Profit Margin" 
        eyebrow="Analytics > Profitability"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Gross Margin" value="68%" delta="Target: 70%" />
        <StatCard label="Highest Margin Item" value="Soda" delta="92%" />
      </div>
