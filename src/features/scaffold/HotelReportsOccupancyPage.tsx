...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, PieChart } from 'lucide-react';

export default function HotelReportsOccupancyPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard label="MTD Occupancy" value="78%" delta="+4%" />
        <StatCard label="YTD Occupancy" value="74%" delta="" />
      </div>
