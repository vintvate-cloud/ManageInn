...
export default function RestaurantRepeatPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Repeat Rate" value="42%" delta="+2% from last month" />
        <StatCard label="Churn Risk" value="14" delta="Guests" />
      </div>
