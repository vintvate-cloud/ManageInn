...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, ClipboardList } from 'lucide-react';

export default function HybridInventoryPurchasesPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Pending Requests" value="8" delta="Awaiting Approval" />
        <StatCard label="Approved Value" value="$4,500" delta="This Week" />
      </div>
