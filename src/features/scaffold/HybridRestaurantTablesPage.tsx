...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Table2 } from 'lucide-react';

export default function HybridRestaurantTablesPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Active Tables" 
        eyebrow="Restaurant > Dining Area"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Seated Guests" value="45" delta="" />
        <StatCard label="Table Turn Rate" value="45m" delta="Avg" />
      </div>
