...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Bed } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard label="Total Rooms" value="120" delta="+2" />
        <StatCard label="Occupied" value="84" delta="70%" />
        <StatCard label="Available" value="32" delta="26%" />
        <StatCard label="Maintenance" value="4" delta="4%" />
      </div>
      ...
      ['310', 'Presidential', <span className="text-blue-500 bg-blue-500/10 px-2 py-1 rounded">Occupied</span>, '3rd Floor', 'In Progress', <ActionButtons />],
        ...
        <div className="p-4 border-t border-border flex justify-between items-center text-sm text-muted-foreground bg-muted/10">
          <div>Showing 1 to 4 of 48 results</div>
