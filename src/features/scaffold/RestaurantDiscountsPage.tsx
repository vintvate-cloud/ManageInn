...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, BadgePercent } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Active Codes" value="5" delta="" />
        <StatCard label="Discount Given" value="$120" delta="Today" />
      </div>
