...
export default function HybridHotelPendingPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Pending Bookings" 
        eyebrow="Hotel > Pipeline"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Unconfirmed" value="8" delta="Action Required" />
        <StatCard label="Deposit Pending" value="$1,200" delta="" />
      </div>
