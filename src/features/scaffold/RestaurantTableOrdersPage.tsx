...
export default function RestaurantTableOrdersPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Table-wise Orders" 
        eyebrow="Orders > Tables"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Occupied Tables" value="14/20" delta="" />
        <StatCard label="Open Tabs" value="$840" delta="" />
      </div>
