...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Hotel } from 'lucide-react';

export default function HybridRevenueHotelPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Hotel Revenue" 
        eyebrow="Revenue > Hotel"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Room Revenue" value="$8,200" delta="Today" />
        <StatCard label="Avg Room Rate" value="$215" delta="" />
      </div>
