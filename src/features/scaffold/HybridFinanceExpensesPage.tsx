...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Wallet } from 'lucide-react';

export default function HybridFinanceExpensesPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Expenses" 
        eyebrow="Finance > Outflow"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Total Expenses (MTD)" value="$42,500" delta="On budget" />
        <StatCard label="Largest Category" value="Payroll" delta="65%" />
      </div>
