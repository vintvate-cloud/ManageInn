...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, UserCheck } from 'lucide-react';

export default function HybridStaffOndutyPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Currently Clocked In" value="24" delta="" />
        <StatCard label="Hotel/Rest Ratio" value="14/10" delta="" />
      </div>
