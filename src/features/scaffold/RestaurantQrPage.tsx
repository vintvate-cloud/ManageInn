...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, QrCode } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Active QR Orders" value="8" delta="" />
        <StatCard label="Revenue (QR)" value="$450" delta="Today" />
      </div>
