...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, AlertTriangle } from 'lucide-react';

export default function HybridInventoryAlertsPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Critical Items" value="4" delta="Order Immediately" />
        <StatCard label="Warnings" value="12" delta="" />
      </div>
