...
export default function HybridRestaurantCustomersPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Today's Customers" 
        eyebrow="Restaurant > Footfall"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Total Covers" value="142" delta="Today" />
        <StatCard label="Walk-ins" value="85" delta="" />
      </div>
