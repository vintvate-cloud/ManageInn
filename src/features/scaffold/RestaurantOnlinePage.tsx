...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Smartphone } from 'lucide-react';
...
export default function RestaurantOnlinePage() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Online Orders" 
        eyebrow="Orders > Online Delivery"
        action={
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <StatCard label="Active Orders" value="18" delta="" />
        <StatCard label="Avg Prep Time" value="14m" delta="-2m" />
      </div>
