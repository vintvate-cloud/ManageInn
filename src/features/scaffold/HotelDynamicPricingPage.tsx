...
import { Plus, Download, Filter, Search, MoreHorizontal, Edit, Trash2, Sparkles } from 'lucide-react';

export default function HotelDynamicPricingPage() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard label="Auto Pricing" value="Enabled" delta="" />
        <StatCard label="Current Multiplier" value="1.2x" delta="High Demand" />
      </div>
