  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { l: "Clean", v: 0, i: CheckCircle2, c: "bg-op-success/30" },
          { l: "In progress", v: 0, i: Clock, c: "bg-op-pink" },
          { l: "Dirty", v: 0, i: Bed, c: "bg-op-beige" },
          { l: "Maintenance", v: 0, i: Wrench, c: "bg-op-peach" },
        ].map((k) => (
