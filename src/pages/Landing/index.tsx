...
import { Search, DollarSign, MessageCircle, Plus, ArrowRight, Sparkles, Bed, CheckCircle2, Calendar, TrendingUp, Users, Wrench, ShoppingCart, BarChart3, Star, Zap, Shield, Globe, Hotel, Bot } from 'lucide-react';
    ...
    <section ref={ref} className="relative bg-foreground text-background pt-36 pb-24 px-4 overflow-hidden">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mt-10 flex flex-wrap gap-3 justify-center">
          <Link to="/signup" className="hero-cta bg-op-pink text-foreground rounded-full px-7 py-4 font-semibold hover:scale-[1.03] transition">
            Try for free
          </Link>
          <Link to="/signup" className="hero-cta bg-white/10 text-background rounded-full px-7 py-4 font-semibold hover:bg-white/20 transition">
            Request a demo
          </Link>
        </div>
      ...
      <div className="rounded-[36px] p-8 sm:p-16 bg-op-purple text-foreground relative overflow-hidden">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-lg max-w-xl mx-auto">
            Ask anything. ManageInn AI forecasts occupancy, builds schedules, and
        ...
        <div className="mt-12 max-w-2xl mx-auto bg-white rounded-3xl p-6 shadow-xl">
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-4">
            <Bot className="h-4 w-4" /> ManageInn Copilot
          ...
          <div className="rounded-[40px] bg-foreground p-3 shadow-2xl">
            <div className="rounded-[32px] bg-white p-4 min-h-[480px]">
              <div className="text-xs text-muted-foreground mb-3 flex items-center gap-2">
                <MessageCircle className="h-3.5 w-3.5" /> ManageInn Concierge
              </div>
...
function Testimonials() {
  const items = [
    { brand: "AURELIA RESORTS", quote: "Before ManageInn, our operations were split across six tools. Now everything runs in one place. Our team saves 30+ hours a week.", name: "Regina Kacajeva", role: "Director of Operations", color: "bg-op-peach" },
...
function FAQ() {
  const items = [
    { q: "What is ManageInn and how does it work?", a: "ManageInn is an AI-native operating system for hotels. It unifies your PMS, channel manager, housekeeping, revenue, CRM, accounting and guest messaging in one platform — with an AI copilot that automates the busywork." },
    { q: "Is ManageInn a PMS, a channel manager, or both?", a: "Both, and more. ManageInn replaces your PMS, channel manager, RMS, and guest messaging tools with a single unified system, so you stop paying for — and reconciling — five different vendors." },
    { q: "Can I use ManageInn for boutique hotels and resorts?", a: "Yes. ManageInn runs single-property boutiques, resorts, hostels, serviced apartments, and global groups with hundreds of locations. The platform scales with you." },
    { q: "Will it integrate with my existing systems?", a: "ManageInn integrates with Stripe, QuickBooks, Xero, WhatsApp, Booking.com, Airbnb, Expedia, Google Hotels, Oracle, Salesforce and more — plus an open API for everything else." },
    { q: "How does ManageInn pricing work?", a: "Pricing is per room, per month, with three tiers (Starter, Growth, Enterprise). All plans include the AI copilot, unlimited users, and 24/7 support." },
    ...
    <section className="px-3 sm:px-6 py-6">
      <div className="rounded-[36px] bg-op-orange p-8 sm:p-20 text-center min-h-[70vh] flex flex-col justify-center">
        ...
        <div className="mt-12 flex flex-wrap gap-3 justify-center">
          <Link to="/signup" className="bg-foreground text-background rounded-full px-8 py-4 font-semibold inline-flex items-center gap-2 hover:scale-[1.03] transition">
            Start free trial <ArrowRight className="h-4 w-4" />
          </Link>
          <Link to="/signup" className="bg-white text-foreground rounded-full px-8 py-4 font-semibold hover:scale-[1.03] transition">
            Book a demo
          </Link>
        </div>
    ...
    <section className="px-3 sm:px-6 py-6">
      <div className="rounded-[36px] bg-foreground text-background p-8 sm:p-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg text-background/70 max-w-xl">
            From signup to a fully running hotel, ManageInn guides you with live previews, smart defaults, and a copilot that never sleeps.
          </p>
        </div>
